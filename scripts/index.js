      ...
      <div class='card-body'>
        ${
          url
            ...
            : `<img width='100%' height='150px' style="object-fit: cover; object-position: center"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReiKeTsm26jLOx1RQhXGkRSPWNj2tCeMKdUA&usqp=CAU" alt='card image cap' class='card-image-top md-3 rounded-lg' />`
        }
...
const htmlModalContent = ({ id, title, description, url }) => {
  const date = new Date(parseInt(id)); //converting string into integer we use parseint()
  return `
  <div id = ${id}>
  ${
    url
